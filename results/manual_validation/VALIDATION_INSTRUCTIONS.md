...
## Overview
This file contains a stratified sample of 37 abstracts for manual validation of the machine learning classification model. The sample is designed to assess model accuracy across different confidence levels and information types.
...
3 Absence | High (≥0.9) | No species               1
4 Absence | High (≥0.9) | Species detected         1
...
Generated: 2025-09-02 13:41:32.923478
