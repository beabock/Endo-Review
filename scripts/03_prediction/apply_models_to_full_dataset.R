...
output_file <- "results/outputs/ML_prediction_results.txt"
sink(output_file, append = FALSE, split = TRUE)
cat("Log file for applying models to the full dataset\n")
cat("Generated by: scripts/03_prediction/apply_models_to_full_dataset.R\n")
...
cat("Column name harmonization mapping defined.\n")
# =============================================================================
...
labeled_abstracts <- read.csv("data/raw/Training_labeled_abs_6.csv") %>%
  clean_names()
cat("Loaded in training data to avoid predicting on labeled abstracts\n")
...
}, file = "results/outputs/manuscript_prediction_thresholds.txt")
...
}, file = "results/outputs/manuscript_classification_examples.txt")
...
}, file = "results/outputs/manuscript_processing_statistics.txt")
...
capture.output(
  ...
  file = "results/outputs/classification_summary.txt"
)
