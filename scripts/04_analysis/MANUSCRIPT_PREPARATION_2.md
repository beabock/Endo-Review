...
Abstract
Fungal endophytes have been detected in every plant taxon studied for them, from bryophytes and ferns to gymnosperms and angiosperms. This remarkable breadth makes them among the most widely distributed plant symbionts known. However, our systematic synthesis of 19,071 research articles reveals that this ubiquity rests on extremely limited and biased sampling: fewer than 0.5% of described plant species have ever been examined for endophytes, and research is heavily concentrated in the Global North (77% of studies) with hotspots in the United States and Europe. Using a machine learning-driven pipeline, we distinguish genuine detection from assumption, quantify the rarity of true absences, and map geographic and taxonomic biases in endophyte research. These findings highlight the extraordinary reach of fungal endophytes while clarifying the limits of current knowledge, reframing ubiquity as “everywhere studied” rather than “in all plants at all times.”
Introduction
