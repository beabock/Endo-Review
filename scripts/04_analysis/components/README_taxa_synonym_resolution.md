...
## Pre-Monsoon test harness
Run the dedicated validation script before submitting the full Monsoon job:
```bash
python scripts/04_analysis/components/test_taxa_synonym_resolution.py --sample-rows 12
```

This test script:
- builds a small GBIF taxon fixture from the sample rows,
- runs the resolver against that fixture,
- checks required columns,
- verifies row preservation,
- and confirms the unresolved review and checkpoint outputs were written.
