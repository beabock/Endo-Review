...
3.  **Figure 4 (PRISMA / `create_figure1a.R`):**
    ...
    * **Action:** Per [CITE: `visualize_taxa_results_manuscript_log.txt`], the 19,071 step must be explicitly labeled: "(excluding 1,436 mycorrhizal-only studies)".
